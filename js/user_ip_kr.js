...
// 根据国家代码和语言获取国家名称
function getCountryNameByCode(countries, code, language = "ko") {
    const country = countries.find((country) => country.alpha2 === code);  // 使用 alpha2 匹配
    return country ? country[language] || country.english : "지구";  // 如果指定语言不存在，返回英语名称，默认值为 "지구"
}
